...
export function _saveQuestion( {question, optionA, optionB, authedUser }) {
  ...
  return new Promise((res, rej) => {
    ...
    // const formattedQuestion = formatQuestion({question, optionA, optionB, authedUser})
